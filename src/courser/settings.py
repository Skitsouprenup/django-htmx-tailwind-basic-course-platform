...
SECRET_KEY = 'django-insecure-_ls!(j&dl6k32)5naeklfz%(z8)1dbot()j6vn=yt00v2(g1jm'
...
STATIC_URL = 'static/'
# For user-uploaded files. Relative path. Development Only.
MEDIA_URL = 'media/'
# For user-uploaded files. Absolute path. Development Only.
